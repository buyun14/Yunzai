...
> §3.2 新增 `diff.js` 时顺手也加进去了（现为 97.60 / 91.89 / 100 / 98.67）。
>
> 换句话说：**新增目录要回来补清单，新增文件也要。**

**基线（2026-09-24，阶段 5 §3.2 后，共 514 个用例）**：
...
（更早的几次基线：阶段 5 §3.1 后是 95.87 / 90.67 / 95.80 / 97.42；
阶段 4 完成后是 95.83 / 90.84 / 95.23 / 97.06；
